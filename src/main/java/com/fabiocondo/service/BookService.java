...
public interface BookService {
    ...
    Book save(String name, String description, String author, Long subjectId, MultipartFile coverImageFile, MultipartFile file) throws SubjectNotFoundException;

    Book update(Long id, String name, String description, String author, Long subjectId, MultipartFile coverImageFile, MultipartFile file) throws BookNotFoundException, SubjectNotFoundException;

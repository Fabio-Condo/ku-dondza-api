...
public interface ArticleService {
    ...
    Article save(String title, String content, MultipartFile file) throws SubjectNotFoundException;

    Article update(Long id, String title, String content, MultipartFile file) throws ArticleNotFoundException, SubjectNotFoundException;

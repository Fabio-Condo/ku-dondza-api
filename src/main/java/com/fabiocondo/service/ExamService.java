...
public interface ExamService {
    ...
    Exam save(ExamType status, Institution institution, boolean premium, Long year, Long subjectId, String number, MultipartFile file) throws SubjectNotFoundException;

    Exam update(Long id, ExamType status, Institution institution, boolean premium, Long year, Long subjectId, String number, MultipartFile file) throws ExamNotFoundException, SubjectNotFoundException;
